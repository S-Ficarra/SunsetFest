...
describe('NewsService', () => {
    ...
    it('should return a news just created', async () => {
        const foundNews3 = new News (userRepository.users[0], new Date, new Date, true, new Content('title3', 'text3', Buffer.from('image')));  
    ...
    it('should return a news with titleEdited and textEdited', async () => {
        const newsEdited = new News (userRepository.users[0], new Date, new Date, true, new Content('titleEdited', 'textEdited', Buffer.from('image')));
        newsEdited.setId(1)
